...
public class TestEnum {
    ...
    */
           ...
           //On itère sur le domaine de la variable choisie
            for (indexval[varchoisie.getIndex()] = 0;indexval[varchoisie.getIndex()] < varchoisie.getDomaine().size(); indexval[varchoisie.getIndex()]++) {
               ...
               for(Variable filtre: variable)
               {
                   ...
                   {
                       filtrage(variable,con,filtre,index);
                   }
                }
     ...
     * @param indice : indique l'indice de la nouvelle variable dans l'arrayList des variables.
     */
    public  void filtrage(ArrayList<Variable> variable,Contrainte con,Variable filtre,int indice)
    {
        ...
        */
        ...
        ////System.out.println("**** "+tempDomaine);
        ...
        for(double val : tempDomaine)
        {
            ...
            */
            String stringconst;
                ...
                variable.get(indice - 1).setDomaine(filtre.getDomaine());
        }
    ...
    public void launch()
    {
        ...
        String nom = "outputs/resultat TestEnum_faible.jcsp";

	    try {
			fich = new PrintWriter(new BufferedWriter(new FileWriter(nom)));
                        fich.println("\t\t\t\t *****************NOUVELLE EVALUATION (ALGORITHME TestEnum faible) DU "+dateStr+"*****************");
        ...
        result.clear();
        condition  = anticipation(BienvenueController.variable, BienvenueController.con,new Variable());
